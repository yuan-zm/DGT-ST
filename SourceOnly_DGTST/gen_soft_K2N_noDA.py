# Common
from dataset.Nuscenes_testset_Sparse import nuScenes_infer_B    
...
parser.add_argument('--checkpoint_path',
                    default='/home/yzm/code/next_paper3/SourceOnly_DGTST/logs/sk2nusc_10/Ori_M34_XYZ_4Gpu/2024-2-19-22_21/checkpoint_val_Sp.tar',
...
parser.add_argument('--result_dir', default='res_pred/Ori_M34_XYZ_4Gpu_Sp/',
...
parser.add_argument(
        '--cfg',
        dest='config_file',
        default='configs/sourceOnly_sk2nusc_10.yaml',
        metavar='FILE',
...
class Tester:
    def __init__(self):
        ...
        self.test_dataset = nuScenes_infer_B(cfg, FLAGS.infer_mode)  # [gen_pselab | test]
            ...
            for batch_idx, batch_data in enumerate(tqdm_loader):
                ...
                for scan_i in range(len(cloud_inds)):
                    ...
                    if FLAGS.only_pred == 0:
                        ...
                        np.save(output_path_pro, batch_data['sp_logits'].cpu().numpy())
