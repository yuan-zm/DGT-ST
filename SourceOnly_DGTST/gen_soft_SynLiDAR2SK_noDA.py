...
parser.add_argument('--checkpoint_path',
                    default='logs/Ori_M34_XYZ/2024-2-17-07_28/checkpoint_val_Sp.tar',
...
parser.add_argument('--result_dir', default='res_pred/Ori_M34_XYZ_Sp/',
...
parser.add_argument('--config_file', default='configs/sourceOnly_syn2sk.yaml',  # multi_scale_D20cm
...
class Tester:
    def __init__(self):
        ...
        self.net = MinkUNet34(3, 20).to(device)
