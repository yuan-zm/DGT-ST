# Common
from dataset.semkitti_test_Sparse import SemanticKITTI
...
parser.add_argument('--checkpoint_path',
                    default='logs/nusc2sk_10/Ori_M34_XYZ/2024-2-21-06_25/checkpoint_epoch_10.tar',
...
parser.add_argument('--result_dir', default='res_pred/n2sk/n2sk_Ori_M34_XYZ_Epoch10/',
...
parser.add_argument('--config_file', default='configs/sourceOnly_nusc2sk_10.yaml',  # multi_scale_D20cm
...
class Tester:
    def __init__(self):
        ...
        self.test_dataset = SemanticKITTI(cfg, FLAGS.infer_mode)  # [gen_pselab | test]
        ...
        self.net = MinkUNet34(3, 11).to(device)
